...
public class PopulationTimeSeries_JFrame extends JFrame {

    public PopulationTimeSeries_JFrame(final String title ) {
        super( title );
    ...
    public static void main( final String[ ] args ) {
        ...
        final PopulationTimeSeries_JFrame ts = new PopulationTimeSeries_JFrame( title );
        ts.pack( );
